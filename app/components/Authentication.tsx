...
export default function Authentication({ toggleAuth, toggleSignin, isLogin }: { toggleAuth: () => void, toggleSignin: () => void, isLogin: boolean }) {
    return (
        <div className='fixed top-0 bottom-0 left-0 right-0 z-10 md:flex'>
            ...
            <div className='md:w-1/2 p-4 bg-white overflow-scroll no-scrollbar w-full h-screen'>
                <Form toggleAuth={toggleAuth} toggleSignin={toggleSignin} isLogin={isLogin}/>
            </div>
        </div>
    )
}